...
export default class Item5e extends SystemDocumentMixin(Item) {
  ...
  *allApplicableEffects() {
  ...
  async displayCard(options={}) {
    ...
    const html = await renderTemplate("systems/dnd5e-2014/templates/chat/item-card.hbs", templateData);
  ...
  static async createScrollFromSpell(spell, options={}, config={}) {
    ...
    if ( config.dialog !== false ) {
      ...
      const result = await Dialog.prompt({
        ...
        content: await renderTemplate("systems/dnd5e-2014/templates/apps/spell-scroll-dialog.hbs", {
  ...
  static async createDialog(data={}, { parent=null, pack=null, types=null, ...options }={}) {
    ...
    const content = await renderTemplate("systems/dnd5e-2014/templates/apps/document-create.hbs", {
      folders, name, type,
      folder: data.folder,
