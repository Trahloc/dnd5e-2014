...
DND5E.abilities = {
  str: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/abilities/strength.svg"
  },
  dex: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/abilities/dexterity.svg"
  },
  con: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/abilities/constitution.svg"
  },
  int: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/abilities/intelligence.svg",
    defaults: { vehicle: 0 }
  },
  wis: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/abilities/wisdom.svg",
    defaults: { vehicle: 0 }
  },
  cha: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/abilities/charisma.svg",
    defaults: { vehicle: 0 }
  },
  hon: {
...
DND5E.itemProperties = {
  ...
  concentration: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/statuses/concentrating.svg",
  ...
  mgc: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/properties/magical.svg",
    isPhysical: true
  },
  rch: {
  ...
  ritual: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/items/spell.svg",
...
DND5E.damageTypes = {
  acid: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/damage/acid.svg",
  ...
  bludgeoning: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/damage/bludgeoning.svg",
    isPhysical: true,
  ...
  cold: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/damage/cold.svg",
  ...
  fire: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/damage/fire.svg",
  ...
  force: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/damage/force.svg",
  ...
  lightning: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/damage/lightning.svg",
  ...
  necrotic: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/damage/necrotic.svg",
  ...
  piercing: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/damage/piercing.svg",
    isPhysical: true,
  ...
  poison: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/damage/poison.svg",
  ...
  psychic: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/damage/psychic.svg",
  ...
  radiant: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/damage/radiant.svg",
  ...
  slashing: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/damage/slashing.svg",
    isPhysical: true,
  ...
  thunder: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/damage/thunder.svg",
...
DND5E.healingTypes = {
  healing: {
    label: "DND5E.Healing",
    icon: "systems/dnd5e-2014/icons/svg/damage/healing.svg",
    color: new Color(0x46C252)
  },
  temphp: {
    label: "DND5E.HealingTemp",
    icon: "systems/dnd5e-2014/icons/svg/damage/temphp.svg",
...
DND5E.encumbrance = {
  ...
  effects: {
    encumbered: {
      ...
      icon: "systems/dnd5e-2014/icons/svg/statuses/encumbered.svg"
    },
    heavilyEncumbered: {
      name: "EFFECT.DND5E.StatusHeavilyEncumbered",
      icon: "systems/dnd5e-2014/icons/svg/statuses/heavily-encumbered.svg"
    },
    exceedingCarryingCapacity: {
      name: "EFFECT.DND5E.StatusExceedingCarryingCapacity",
      icon: "systems/dnd5e-2014/icons/svg/statuses/exceeding-carrying-capacity.svg"
    }
  },
  threshold: {
    encumbered: {
...
DND5E.spellcastingTypes = {
  leveled: {
    ...
    img: "systems/dnd5e-2014/icons/spell-tiers/{id}.webp",
    progression: {
      full: {
...
DND5E.conditionTypes = {
  bleeding: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/statuses/bleeding.svg",
    pseudo: true
  },
  blinded: {
    label: "DND5E.ConBlinded",
    icon: "systems/dnd5e-2014/icons/svg/statuses/blinded.svg",
    reference: "Compendium.dnd5e.rules.JournalEntry.w7eitkpD7QQTB6j0.JournalEntryPage.0b8N4FymGGfbZGpJ",
    special: "BLIND"
  },
  charmed: {
    label: "DND5E.ConCharmed",
    icon: "systems/dnd5e-2014/icons/svg/statuses/charmed.svg",
  ...
  cursed: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/statuses/cursed.svg",
    pseudo: true
  },
  deafened: {
    label: "DND5E.ConDeafened",
    icon: "systems/dnd5e-2014/icons/svg/statuses/deafened.svg",
    reference: "Compendium.dnd5e.rules.JournalEntry.w7eitkpD7QQTB6j0.JournalEntryPage.6G8JSjhn701cBITY"
  },
  diseased: {
    label: "DND5E.ConDiseased",
    icon: "systems/dnd5e-2014/icons/svg/statuses/diseased.svg",
    pseudo: true,
  ...
  exhaustion: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/statuses/exhaustion.svg",
  ...
  restrained: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/statuses/restrained.svg",
  ...
  silenced: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/statuses/silenced.svg",
    pseudo: true
  },
  stunned: {
    label: "DND5E.ConStunned",
    icon: "systems/dnd5e-2014/icons/svg/statuses/stunned.svg",
  ...
  surprised: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/statuses/surprised.svg",
    pseudo: true
  },
  transformed: {
    label: "EFFECT.DND5E.StatusTransformed",
    icon: "systems/dnd5e-2014/icons/svg/statuses/transformed.svg",
    pseudo: true
  },
  unconscious: {
    label: "DND5E.ConUnconscious",
    icon: "systems/dnd5e-2014/icons/svg/statuses/unconscious.svg",
...
DND5E.statusEffects = {
  burrowing: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/statuses/burrowing.svg",
    special: "BURROW"
  },
  concentrating: {
  ...
  dead: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/statuses/dead.svg",
    special: "DEFEATED"
  },
  dodging: {
    name: "EFFECT.DND5E.StatusDodging",
    icon: "systems/dnd5e-2014/icons/svg/statuses/dodging.svg"
  },
  ethereal: {
    name: "EFFECT.DND5E.StatusEthereal",
    icon: "systems/dnd5e-2014/icons/svg/statuses/ethereal.svg"
  },
  flying: {
    name: "EFFECT.DND5E.StatusFlying",
    icon: "systems/dnd5e-2014/icons/svg/statuses/flying.svg",
    special: "FLY"
  },
  hiding: {
    name: "EFFECT.DND5E.StatusHiding",
    icon: "systems/dnd5e-2014/icons/svg/statuses/hiding.svg"
  },
  hovering: {
    name: "EFFECT.DND5E.StatusHovering",
    icon: "systems/dnd5e-2014/icons/svg/statuses/hovering.svg",
    special: "HOVER"
  },
  marked: {
    name: "EFFECT.DND5E.StatusMarked",
    icon: "systems/dnd5e-2014/icons/svg/statuses/marked.svg"
  },
  sleeping: {
    name: "EFFECT.DND5E.StatusSleeping",
    icon: "systems/dnd5e-2014/icons/svg/statuses/sleeping.svg",
    statuses: ["incapacitated", "unconscious"]
  },
  stable: {
    name: "EFFECT.DND5E.StatusStable",
    icon: "systems/dnd5e-2014/icons/svg/statuses/stable.svg"
  }
};
...
DND5E.traits = {
  saves: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/trait-saves.svg",
  ...
  skills: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/trait-skills.svg",
  ...
  languages: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/trait-languages.svg"
  },
  armor: {
    labels: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/trait-armor-proficiencies.svg",
  ...
  weapon: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/trait-weapon-proficiencies.svg",
  ...
  tool: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/trait-tool-proficiencies.svg",
  ...
  di: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/trait-damage-immunities.svg",
  ...
  dr: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/trait-damage-resistances.svg",
    configKey: "damageTypes"
  },
  dv: {
    labels: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/trait-damage-vulnerabilities.svg",
    configKey: "damageTypes"
  },
  ci: {
    labels: {
    ...
    icon: "systems/dnd5e-2014/icons/svg/trait-condition-immunities.svg",
...
DND5E.defaultArtwork = {
  Item: {
    background: "systems/dnd5e-2014/icons/svg/items/background.svg",
    class: "systems/dnd5e-2014/icons/svg/items/class.svg",
    consumable: "systems/dnd5e-2014/icons/svg/items/consumable.svg",
    container: "systems/dnd5e-2014/icons/svg/items/container.svg",
    equipment: "systems/dnd5e-2014/icons/svg/items/equipment.svg",
    feat: "systems/dnd5e-2014/icons/svg/items/feature.svg",
    loot: "systems/dnd5e-2014/icons/svg/items/loot.svg",
    race: "systems/dnd5e-2014/icons/svg/items/race.svg",
    spell: "systems/dnd5e-2014/icons/svg/items/spell.svg",
    subclass: "systems/dnd5e-2014/icons/svg/items/subclass.svg",
    tool: "systems/dnd5e-2014/icons/svg/items/tool.svg",
    weapon: "systems/dnd5e-2014/icons/svg/items/weapon.svg"
  }
};
...
DND5E.tokenRings = {
  ...
  spriteSheet: "systems/dnd5e-2014/tokens/composite/token-rings.json",
  shaderClass: null
};
