...
export default class CompendiumBrowser extends HandlebarsApplicationMixin(ApplicationV2) {
  ...
  static PARTS = {
    header: {
      id: "header",
      classes: ["header"],
      template: "systems/dnd5e-2014/templates/compendium/browser-header.hbs"
    },
    search: {
      id: "sidebar-search",
      classes: ["sidebar-part", "filter-element"],
      template: "systems/dnd5e-2014/templates/compendium/browser-sidebar-search.hbs"
    },
    types: {
      id: "sidebar-types",
      classes: ["sidebar-part"],
      template: "systems/dnd5e-2014/templates/compendium/browser-sidebar-types.hbs"
    },
    filters: {
      id: "sidebar-filters",
      classes: ["sidebar-part"],
      template: "systems/dnd5e-2014/templates/compendium/browser-sidebar-filters.hbs"
    },
    results: {
      id: "results",
      classes: ["results"],
      template: "systems/dnd5e-2014/templates/compendium/browser-results.hbs",
      templates: ["systems/dnd5e-2014/templates/compendium/browser-entry.hbs"],
      scrollable: [""]
    },
    footer: {
      id: "footer",
      classes: ["footer"],
      template: "systems/dnd5e-2014/templates/compendium/browser-footer.hbs"
    },
    tabs: {
      id: "tabs",
      classes: ["tabs", "tabs-left"],
      template: "systems/dnd5e-2014/templates/compendium/browser-tabs.hbs"
    }
  };
  ...
  static TABS = [
    {
      ...
      svg: "systems/dnd5e-2014/icons/svg/items/class.svg",
      documentClass: "Item",
      types: ["class"]
    },
    {
      ...
      svg: "systems/dnd5e-2014/icons/svg/items/subclass.svg",
      documentClass: "Item",
      types: ["subclass"]
    },
    {
      ...
      svg: "systems/dnd5e-2014/icons/svg/items/race.svg",
      documentClass: "Item",
      types: ["race"]
    },
    {
    ...
    },
    {
      ...
      svg: "systems/dnd5e-2014/icons/svg/items/background.svg",
      documentClass: "Item",
      types: ["background"]
    },
    {
      ...
      svg: "systems/dnd5e-2014/icons/svg/backpack.svg",
      documentClass: "Item",
      types: ["physical"]
    },
    {
    ...
    },
    {
      ...
      svg: "systems/dnd5e-2014/icons/svg/monster.svg",
      documentClass: "Actor",
      types: ["npc"]
    },
    {
      ...
      svg: "systems/dnd5e-2014/icons/svg/vehicle.svg",
      documentClass: "Actor",
      types: ["vehicle"]
    },
    {
  ...
  async _renderResult(entry, documentClass) {
    ...
    const html = await renderTemplate("systems/dnd5e-2014/templates/compendium/browser-entry.hbs", context);
