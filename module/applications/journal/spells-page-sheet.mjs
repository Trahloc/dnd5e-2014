...
export default class JournalSpellListPageSheet extends JournalPageSheet {
  ...
  /** @inheritDoc */
  get template() {
    if ( this.options.displayAsTable ) return "systems/dnd5e-2014/templates/journal/page-spell-list-table.hbs";
    return `systems/dnd5e-2014/templates/journal/page-spell-list-${this.isEditable ? "edit" : "view"}.hbs`;
  }
