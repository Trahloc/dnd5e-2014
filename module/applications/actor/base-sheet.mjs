...
export default class ActorSheet5e extends ActorSheetMixin(ActorSheet) {
  ...
  /** @override */
  get template() {
    if ( !game.user.isGM && this.actor.limited ) return "systems/dnd5e-2014/templates/actors/limited-sheet.hbs";
    return `systems/dnd5e-2014/templates/actors/${this.actor.type}-sheet.hbs`;
  }
