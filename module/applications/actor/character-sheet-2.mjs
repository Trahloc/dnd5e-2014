...
export default class ActorSheet5eCharacter2 extends ActorSheetV2Mixin(ActorSheet5eCharacter) {
  ...
  /** @override */
  get template() {
    if ( !game.user.isGM && this.actor.limited ) return "systems/dnd5e-2014/templates/actors/limited-sheet-2.hbs";
    return "systems/dnd5e-2014/templates/actors/character-sheet-2.hbs";
  }
