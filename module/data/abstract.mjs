...
export class ItemDataModel extends SystemDataModel {
   ...
   * @type {string}
   */
  static ITEM_TOOLTIP_TEMPLATE = "systems/dnd5e-2014/templates/items/parts/item-tooltip.hbs";
  ...
  prepareBaseData() {
    if ( this.parent.isEmbedded ) {
      const sourceId = this.parent.flags.dnd5e-2014?.sourceId ?? this.parent._stats.compendiumSource
