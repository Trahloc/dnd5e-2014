...
export default class WeaponData extends ItemDataModel.mixin(
  ...
  get _typeCriticalThreshold() {
    return this.parent?.actor?.flags.dnd5e-2014?.weaponCriticalThreshold ?? Infinity;
  }
  ...
  get proficiencyMultiplier() {
    ...
    const improvised = (this.type.value === "improv") && !!actor.getFlag("dnd5e-2014", "tavernBrawlerFeat");
