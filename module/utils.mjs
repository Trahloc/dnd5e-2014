...
export async function preloadHandlebarsTemplates() {
  const partials = [
    // Shared Partials
    "systems/dnd5e-2014/templates/shared/active-effects.hbs",
    "systems/dnd5e-2014/templates/shared/active-effects2.hbs",
    "systems/dnd5e-2014/templates/shared/inventory.hbs",
    "systems/dnd5e-2014/templates/shared/inventory2.hbs",
    "systems/dnd5e-2014/templates/apps/parts/trait-list.hbs",

    // Actor Sheet Partials
    "systems/dnd5e-2014/templates/actors/parts/actor-classes.hbs",
    "systems/dnd5e-2014/templates/actors/parts/actor-trait-pills.hbs",
    "systems/dnd5e-2014/templates/actors/parts/actor-traits.hbs",
    "systems/dnd5e-2014/templates/actors/parts/actor-features.hbs",
    "systems/dnd5e-2014/templates/actors/parts/actor-inventory.hbs",
    "systems/dnd5e-2014/templates/actors/parts/actor-spellbook.hbs",
    "systems/dnd5e-2014/templates/actors/parts/actor-warnings.hbs",
    "systems/dnd5e-2014/templates/actors/parts/actor-warnings-dialog.hbs",
    "systems/dnd5e-2014/templates/actors/parts/biography-textbox.hbs",
    "systems/dnd5e-2014/templates/actors/tabs/character-biography.hbs",
    "systems/dnd5e-2014/templates/actors/tabs/character-details.hbs",
    "systems/dnd5e-2014/templates/actors/tabs/creature-features.hbs",
    "systems/dnd5e-2014/templates/actors/tabs/creature-spells.hbs",
    "systems/dnd5e-2014/templates/actors/tabs/group-members.hbs",
    "systems/dnd5e-2014/templates/actors/tabs/npc-biography.hbs",

    // Actor Sheet Item Summary Columns
    "systems/dnd5e-2014/templates/actors/parts/columns/column-feature-controls.hbs",
    "systems/dnd5e-2014/templates/actors/parts/columns/column-formula.hbs",
    "systems/dnd5e-2014/templates/actors/parts/columns/column-recovery.hbs",
    "systems/dnd5e-2014/templates/actors/parts/columns/column-roll.hbs",
    "systems/dnd5e-2014/templates/actors/parts/columns/column-uses.hbs",

    // Item Sheet Partials
    "systems/dnd5e-2014/templates/items/parts/item-action.hbs",
    "systems/dnd5e-2014/templates/items/parts/item-activation.hbs",
    "systems/dnd5e-2014/templates/items/parts/item-advancement.hbs",
    "systems/dnd5e-2014/templates/items/parts/item-description.hbs",
    "systems/dnd5e-2014/templates/items/parts/item-mountable.hbs",
    "systems/dnd5e-2014/templates/items/parts/item-spellcasting.hbs",
    "systems/dnd5e-2014/templates/items/parts/item-source.hbs",
    "systems/dnd5e-2014/templates/items/parts/item-summary.hbs",
    "systems/dnd5e-2014/templates/items/parts/item-tooltip.hbs",

    // Journal Partials
    "systems/dnd5e-2014/templates/journal/parts/journal-table.hbs",

    // Advancement Partials
    "systems/dnd5e-2014/templates/advancement/parts/advancement-ability-score-control.hbs",
    "systems/dnd5e-2014/templates/advancement/parts/advancement-controls.hbs",
    "systems/dnd5e-2014/templates/advancement/parts/advancement-spell-config.hbs"
  ];
